...
const CartCard = ({ id, name, img, quantity, price, des, subtotal, total ,couponApplied}) => {
  ...
  return (
    <>
     {!error ? '' : <Typography sx={{color:'red',pl:{md:7,sm:7}}}>cannot add more than 5 food items</Typography>}
      <Box
        sx={{
          display: 'flex',
          gap: '10px',
